...
vector<int> HiGenAnalyzer::getMotherIdx(edm::Handle<std::vector<pat::PackedGenParticle>> parts, const pat::PackedGenParticle pin){
...
vector<int> HiGenAnalyzer::getDaughterIdx(edm::Handle<std::vector<pat::PackedGenParticle>> parts, const pat::PackedGenParticle pin){
